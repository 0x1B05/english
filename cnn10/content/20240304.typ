...
What's up lovely people! Hope you've had an awesome weekend. Let's start this week strong with some motivation Monday. Remeber #strike[complecency] #underline[complacency] is the constant enemy, so let's learn one thing or do something that #strike[makes] #underline[will make] us a little better today than we were yesterday. I'm Coy Wire, this is CNN10.
...
What's up lovely people! Hope you've had an awesome weekend. Let's start this week strong with some motivation Monday. Remeber complacency is the constant enemy, so let's learn one thing or do something that will make us a little better today than we were yesterday. I'm Coy Wire, this is CNN10.
...
大家好！希望你们度过了愉快的周末。让我们以充满动力的星期一开始这个新的一周。记住，自满是我们的永恒敌人，所以让我们学习一件事或做一些让自己比昨天更好的事情。我是Coy Wire，这里是CNN10。
...
风势很大。天气非常炎热，比过去几天要热得多。而且非常干燥，这种条件使得在这个地区的消防员们面临极大困难，他们仍在与德克萨斯历史上最大的山火作斗争。控制火势的进展仍然很慢。所以还有很多工作要做。同时，许多家庭已经开始了失去一切的悲痛过程，清理过程也已经开始。就像你在我身后看到的，约翰逊家庭，由于风势太大，清理工作变得非常困难。但尽管如此，你现在看到他们正在努力清理残骸，试图寻找任何首饰，任何他们能找到的残留在家中的物品，这是他们建造了20多年的家。我想让你们听一下Johnson Ronnie告诉我的，他大火后第一个回到家看到的景象。
...
唯一一架运送乘客超音速的民用喷气式飞机是协和式飞机(Concorde)。它只能在海上进行超音速飞行。所以你可以从伦敦飞往纽约，但你必须在抵达纽约之前减速，转为次音速飞行。因此，航线非常有限。Concorde是一项备受赞誉的技术成就，也是其乘客的独特奢侈享受。有限的航线和高油耗意味着运营协和式飞机并不划算。然而，它在2003年停止飞行。但是，如果超音速飞机能够在陆地上飞行，它们可以飞往任何地方，商业提案就会发生变化。

NASA和Lockheed Martin希望这架看起来很疯狂的飞机是朝着这个方向迈出的一步。它被设计为在超音速行进时不发出我们几十年来习以为常的巨大音爆。要理解这种原理，了解声爆是如何发生的很重要。就像一艘船，当船在移动时，它带着船身上的重量一起移动。同样，对于超音速飞机，冲击波从飞机上脱落并在整个超音速飞行期间传播到地面。因此，当工程师设计X-59时，他们使用了光滑且长的空气动力学线条来限制冲击波到达地面。发动机于机翼上方，这样发动机产生的冲击波就无法传播到地面，只会向上传播。它仍然是可听到的，像一个轻微的隆隆声。大多数人，如果听到了，甚至都不会注意到。
...
NASA can #strike[exploit it can provide] #underline[take that data, and then be able to present] it to the #strike[regulation organization] #underline[regulatory authorities] to repeal the #underline[overline supersonic] limitations #strike[in the speed of supersonic plane] we are confronting today.
